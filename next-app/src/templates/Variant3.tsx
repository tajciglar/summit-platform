...
import type { Variant3Content } from './variant-3.schema';
...
// Deterministic gradient + accent cycles, drawn from the variant-3 HTML palette
...
/* ============== STICKY TOP BAR ============== */
function TopBar({ content }: { content: Variant3Content }) {
  return (
    <div
    ...
    >
      <div className="max-w-6xl mx-auto flex items-center justify-center">
        <span className="variant-3-heading font-bold text-lg md:text-xl tracking-tight">
    ...
    >
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-5 gap-10 items-center relative z-10">
        <div className="md:col-span-3">
          <p
            className="variant-3-heading font-bold text-sm mb-3"
            style={{ color: '#16A34A' }}
          >
            {h.eyebrow}
          </p>
          <h1
            className="variant-3-heading font-black text-3xl md:text-4xl lg:text-[2.75rem] leading-[1.15] mb-5"
            style={{ color: '#1A2E1A' }}
          >
            {h.headline}
          </h1>
          ...
          <a
            href="#optin"
            className="variant-3-heading variant-3-pulse-glow inline-block text-white font-bold text-base px-8 py-4 rounded-full uppercase tracking-wide mb-4"
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            <p
              className="variant-3-heading font-bold text-xs"
              style={{ color: 'rgba(26,46,26,0.55)' }}
            >
              {h.speakerCountLabel}
            </p>
        ...
        >
          <div className="absolute inset-0">
            ...
            >
              <defs>
                <linearGradient id="variant-3-blob1" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#16A34A" stopOpacity="0.6" />
                  <stop offset="50%" stopColor="#14532D" stopOpacity="0.4" />
                  <stop offset="100%" stopColor="#EAB308" stopOpacity="0.3" />
                </linearGradient>
                <linearGradient id="variant-3-blob2" x1="100%" y1="0%" x2="0%" y2="100%">
                  <stop offset="0%" stopColor="#EAB308" stopOpacity="0.5" />
                  <stop offset="100%" stopColor="#16A34A" stopOpacity="0.2" />
                </linearGradient>
                <linearGradient id="variant-3-blob3" x1="50%" y1="0%" x2="50%" y2="100%">
                  <stop offset="0%" stopColor="#DCFCE7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#16A34A" stopOpacity="0.1" />
                </linearGradient>
              </defs>
              <ellipse cx="200" cy="180" rx="180" ry="160" fill="url(#variant-3-blob1)" />
              <ellipse cx="260" cy="250" rx="130" ry="140" fill="url(#variant-3-blob2)" />
              <ellipse cx="160" cy="280" rx="100" ry="110" fill="url(#variant-3-blob3)" />
          ...
          <div className="relative z-10 text-center p-6">
            ...
            >
              ...
              <p
                className="variant-3-heading font-bold text-lg mb-1"
                style={{ color: '#1A2E1A' }}
              >
                {h.blobCard.daysLabel}
              </p>
              <p
                className="variant-3-heading font-extrabold text-2xl"
                style={{ color: '#16A34A' }}
              >
...
/* ============== PRESS MARQUEE ============== */
function Press({ content }: { content: Variant3Content }) {
  const items = [...content.press.outlets, ...content.press.outlets];
  return (
    <section className="bg-white py-10">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <p
          className="variant-3-heading text-xs font-bold uppercase mb-6"
          style={{
            letterSpacing: '0.2em',
        ...
        <div className="variant-3-marquee-wrap">
          <div className="variant-3-marquee-track">
            {items.map((name, idx) => (
              <span key={`press-${idx}`} className="variant-3-marquee-item">
                {name}
              </span>
            ))}
          </div>
...
/* ============== TRUST BADGES ============== */
function Trust({ content }: { content: Variant3Content }) {
  return (
    <section
...
/* ============== STATS STRIP ============== */
function Stats({ content }: { content: Variant3Content }) {
  return (
    <section className="bg-white py-12">
      <div className="max-w-4xl mx-auto px-6 grid grid-cols-3 gap-6 text-center">
        {content.stats.items.map((item, idx) => (
          ...
          >
            <p
              className="variant-3-heading font-black text-4xl md:text-5xl"
              style={{ color: '#15803D' }}
            >
              {item.value}
            </p>
...
/* ============== OVERVIEW ============== */
function Overview({ content }: { content: Variant3Content }) {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        <div>
          <p
            className="variant-3-heading font-bold text-sm uppercase tracking-wider mb-2"
            style={{ color: '#16A34A' }}
          >
            {o.eyebrow}
          </p>
          <h2
            className="variant-3-heading font-black text-3xl md:text-4xl mb-6"
            style={{ color: '#1A2E1A' }}
          >
            {o.headline}
          </h2>
          ...
          <a
            href="#optin"
            className="variant-3-heading inline-block text-white font-bold px-8 py-4 rounded-full text-base mt-4"
            style={{ background: '#16A34A' }}
          >
            {o.ctaLabel}
          </a>
        ...
        >
          <div className="text-center p-8">
            ...
            <p
              className="variant-3-heading font-bold text-xl mb-1"
              style={{ color: '#1A2E1A' }}
            >
              {o.cardDaysLabel}
            </p>
...
function SpeakersDay({ content, speakers }: Props) {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 text-center">
        <span
          className="variant-3-heading inline-block text-white font-bold text-sm px-5 py-2 rounded-full mb-4"
          style={{ background: '#16A34A' }}
        >
          {content.speakersDay.dayLabel}
        </span>
        <h2
          className="variant-3-heading font-black text-3xl md:text-4xl mb-14"
          style={{ color: '#1A2E1A' }}
        >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-10 md:gap-12">
          {daySpeakers.map((s, idx) => (
            <figure key={s.id} className="flex flex-col items-center">
              <div
                className="variant-3-avatar mb-4"
                style={{
                  width: '140px',
                  height: '140px',
                  fontSize: '1.5rem',
              ...
              <p
                className="variant-3-heading font-bold text-lg"
                style={{ color: '#1A2E1A' }}
              >
                {displayName(s)}
              </p>
...
/* ============== OUTCOMES ============== */
function Outcomes({ content }: { content: Variant3Content }) {
  const o = content.outcomes;
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="max-w-5xl mx-auto px-6">
        <p
          className="variant-3-heading font-bold text-sm uppercase tracking-wider mb-2 text-center"
          style={{ color: '#16A34A' }}
        >
          {o.eyebrow}
        </p>
        <h2
          className="variant-3-heading font-black text-3xl md:text-4xl mb-12 text-center"
          style={{ color: '#1A2E1A' }}
        >
          {o.headline}
        </h2>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
          {o.items.map((item, idx) => (
            ...
            >
              <div
                className="w-14 h-14 rounded-2xl mx-auto mb-4 flex items-center justify-center variant-3-heading font-black text-white text-lg"
                style={{
              ...
              <p
                className="variant-3-heading font-bold"
                style={{ color: '#1A2E1A' }}
              >
                {item.title}
              </p>
...
/* ============== FREE GIFT ============== */
function FreeGift({ content }: { content: Variant3Content }) {
    ...
    >
      <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
        <div className="flex justify-center">
          <div className="relative">
            ...
            >
              ...
              ></div>
              <p
                className="variant-3-heading font-bold text-sm text-center leading-tight"
                style={{ color: '#1A2E1A' }}
              >
                {g.bookTitle}
              </p>
            ...
            <div
              className="absolute -top-3 -right-3 variant-3-heading text-white font-black text-xs px-3 py-1.5 rounded-full shadow-lg"
              style={{
                background: '#EAB308',
        ...
        <div>
          ...
          <h2
            className="variant-3-heading font-black text-2xl md:text-3xl mb-4"
            style={{ color: '#1A2E1A' }}
          >
            {g.headline}
          </h2>
          ...
          <a
            href="#optin"
            className="variant-3-heading variant-3-pulse-glow inline-block text-white font-bold text-sm px-7 py-3.5 rounded-full uppercase tracking-wide"
            style={{ background: '#16A34A' }}
          >
            {g.ctaLabel} &rarr;
          </a>
...
/* ============== BONUS STACK ============== */
function Bonuses({ content }: { content: Variant3Content }) {
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6">
        ...
        <h2
          className="variant-3-heading font-black text-3xl md:text-4xl mb-14 text-center"
          style={{ color: '#1A2E1A' }}
        >
          {b.headline}
        </h2>
        <div className="space-y-8">
          {b.items.map((bonus, idx) => (
            ...
            >
              <span
                className="variant-3-heading font-black text-6xl md:text-7xl leading-none shrink-0 select-none"
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3 flex-wrap">
                  <h3
                    className="variant-3-heading font-bold text-xl"
                    style={{ color: '#1A2E1A' }}
                  >
                    {bonus.title}
                  </h3>
                  <span
                    className="variant-3-heading inline-block text-white font-bold text-xs px-3 py-1 rounded-full shrink-0"
                    style={{ background: '#EAB308' }}
                  >
                    {bonus.valueLabel}
                  </span>
        ...
        <div className="text-center mt-12">
          <a
            href="#optin"
            className="variant-3-heading inline-block text-white font-bold px-10 py-4 rounded-full text-lg"
            style={{ background: '#16A34A' }}
          >
            {b.ctaLabel}
          </a>
...
/* ============== FOUNDERS ============== */
function Founders({ content }: { content: Variant3Content }) {
  const f = content.founders;
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="max-w-5xl mx-auto px-6">
        <h2
          className="variant-3-heading font-black text-3xl md:text-4xl text-center mb-12"
          style={{ color: '#1A2E1A' }}
        >
          {f.headline}
        </h2>
...
/* ============== TESTIMONIALS ============== */
function Testimonials({ content }: { content: Variant3Content }) {
          ...
          {t.items.map((item, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p
                    className="variant-3-heading font-bold text-sm"
                    style={{ color: '#1A2E1A' }}
                  >
                    {item.name}
                  </p>
...
/* ============== PULL QUOTE ============== */
function PullQuote({ content }: { content: Variant3Content }) {
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <p
          className="variant-3-heading font-bold text-2xl md:text-3xl leading-relaxed italic"
          style={{ color: '#FFFFFF' }}
        >
...
function Figures({ content }: { content: Variant3Content }) {
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          {f.items.map((item, idx) => (
            ...
            >
              <p
                className="variant-3-heading font-black text-4xl mb-2"
                style={{ color: '#16A34A' }}
              >
                {item.value}
              </p>
...
/* ============== SHIFTS (TIMELINE) ============== */
function Shifts({ content }: { content: Variant3Content }) {
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="variant-3-timeline space-y-10 pl-1">
            ...
            return (
              <div key={`shift-${idx}`} className="flex gap-6 items-start">
                <div
                  className={
                    isLast
                      ? 'variant-3-timeline-dot variant-3-timeline-dot-last'
                      : 'variant-3-timeline-dot'
                  }
                >
                  <span className="variant-3-heading font-black text-sm text-white">
                    {String(idx + 1).padStart(2, '0')}
                  </span>
                </div>
                <div className="pt-2">
                  <h3
                    className="variant-3-heading font-bold text-xl mb-2"
                    style={{ color: '#1A2E1A' }}
                  >
                    {item.title}
                  </h3>
...
/* ============== CLOSING CTA ============== */
function ClosingCTA({ content }: { content: Variant3Content }) {
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto px-6 text-center">
        <h2
          className="variant-3-heading font-black text-3xl md:text-5xl mb-10"
          style={{ color: '#FFFFFF' }}
        >
          {c.headline}
        </h2>
        <div className="grid grid-cols-2 gap-3 mb-10 max-w-lg mx-auto">
          {c.features.map((feature, idx) => (
            <span
              ...
              className="variant-3-heading text-white font-bold text-sm px-4 py-3 rounded-full flex items-center gap-2 justify-center"
              style={{ background: '#EAB308' }}
            >
              <svg
        ...
        <a
          href="#optin"
          className="variant-3-heading inline-block font-black text-lg px-12 py-5 rounded-full uppercase tracking-wider shadow-xl"
...
/* ============== FAQ ============== */
function FAQ({ content }: { content: Variant3Content }) {
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="max-w-3xl mx-auto px-6">
        <p
        ...
        <div className="space-y-4">
          {content.faqs.map((faq, idx) => (
            ...
            >
              <summary
                className="flex items-center justify-between p-5 variant-3-heading font-bold"
                style={{ color: '#1A2E1A' }}
              >
                {faq.question}
                <span
                  className="variant-3-chevron text-xl"
                  style={{ color: '#16A34A' }}
                  aria-hidden="true"
                >
                  ▼
...
/* ============== FOOTER ============== */
function Footer({ content }: { content: Variant3Content }) {
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div
              ...
              style={{ background: '#16A34A' }}
            >
              <span className="variant-3-heading font-black text-white text-lg">
                {f.brandInitial}
              </span>
            </div>
            <div>
...
/* ============== ROOT COMPONENT ============== */
export function Variant3({ content, speakers, funnelId }: RootProps) {
  return (
    <div className="variant-3-root variant-3-body antialiased">
      <a href="#main-content" className="variant-3-skip-nav">
        Skip to content
      </a>
