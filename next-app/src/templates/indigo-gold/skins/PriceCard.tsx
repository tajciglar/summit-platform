...
import { LAV_SALES, SalesArrowRight, SalesCheckIcon, SalesGiftIcon, salesBtnCtaLg, type TemplateContext } from './shared';
      ...
      <div style={{ maxWidth: 1152, margin: '0 auto' }}>
        ...
        >
          ...
          <div style={{ textAlign: 'center', borderTop: `1px solid ${LAV_SALES.LAV100}`, paddingTop: '1.25rem' }}>
            ...
            <TrackedCheckoutLink href={resolveCheckoutHref(context.wpCheckoutRedirectUrl)} style={salesBtnCtaLg}>
            ...
            {context.wpThankyouRedirectUrl && (
              <p style={{ marginTop: '1.25rem' }}>
                <TrackedDeclineLink href={context.wpThankyouRedirectUrl} style={{ color: '#64748b', fontSize: '0.85rem', textDecoration: 'underline', textUnderlineOffset: '3px' }}>
