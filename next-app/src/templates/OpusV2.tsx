...
// Drawn from the opus-v2 HTML palette (ink + lime + indigo tints).
...
/* ============== STICKY TOP BAR ============== */
function TopBar({ content }: { content: OpusV2Content }) {
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <span className="opus-v2-mono text-xs" style={{ color: '#C4F245' }}>
            {t.codeTag}
          </span>
        ...
        <div className="flex items-center gap-3">
          <span
            className="opus-v2-mono px-2.5 py-1 rounded-full"
            style={{
              fontSize: '0.65rem',
              color: '#DCFF6B',
          ...
          <a
            href="#optin"
            className="opus-v2-cta-primary text-xs md:text-sm font-bold px-5 py-2 rounded-full"
          >
            {t.ctaLabel}
          </a>
        </div>
...
function Hero({ content, speakers }: Props) {
  ...
  return (
    <section
      ...
      style={{ background: '#0A0A0B' }}
    >
      <div className="absolute inset-0 opus-v2-grid-bg"></div>
      <div className="absolute inset-0 opus-v2-noise"></div>
      <div className="relative max-w-7xl mx-auto px-6 pt-20 md:pt-28 pb-20 md:pb-28">
        <div className="flex items-center gap-4 mb-10">
          <span className="opus-v2-mono text-xs" style={{ color: '#DCFF6B' }}>
            {h.sectionLabel}
          </span>
          <span
          ...
          ></span>
          <span className="opus-v2-mono text-xs" style={{ color: '#71717A' }}>
            {h.dateRangeLabel}
          </span>
        </div>
        ...
        <div className="grid md:grid-cols-12 gap-10 items-end">
          <div className="md:col-span-8">
            <p
              className="opus-v2-mono text-sm mb-6 tracking-wide"
              style={{ color: '#DCFF6B' }}
            >
              {h.eyebrow}
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 mb-12">
              <a
                href="#optin"
                className="opus-v2-cta-primary inline-flex items-center gap-3 font-bold px-8 py-4 rounded-full text-base"
              >
                {h.primaryCtaLabel}
                <span className="opus-v2-mono text-sm">→</span>
              </a>
              <a
                href="#what-is-this"
                className="opus-v2-cta-ghost inline-flex items-center gap-2 px-6 py-3.5 rounded-full text-sm font-medium"
              >
                {h.secondaryCtaLabel}
              </a>
            </div>

            <div className="flex items-center gap-4 pt-8 opus-v2-hairline-dark">
          ...
          <aside className="md:col-span-4">
            <p
              className="opus-v2-mono text-xs mb-4"
              style={{ color: '#71717A' }}
            >
              {h.featuredLabel}
            </p>
            ...
            <p
              className="opus-v2-mono mt-4 text-right"
...
/* ============== PRESS MARQUEE ============== */
function Press({ content }: { content: OpusV2Content }) {
  // Duplicate items so the marquee loops seamlessly.
  const items = [...content.press.outlets, ...content.press.outlets];
  return (
    <section className="bg-white py-10 opus-v2-hairline-b">
      <div className="max-w-7xl mx-auto px-6">
        <p
          className="opus-v2-mono text-xs mb-6 text-center"
          style={{ color: '#71717A' }}
        >
          {content.press.eyebrow}
        </p>
        <div className="opus-v2-marquee-wrap">
          <div className="opus-v2-marquee-track">
            {items.map((name, idx) => (
              <span className="opus-v2-marquee-item" key={`press-${idx}`}>
                {name}
              </span>
            ))}
          </div>
...
/* ============== STATS STRIP ============== */
function Stats({ content }: { content: OpusV2Content }) {
  return (
    <section className="bg-white py-16 md:py-20 opus-v2-hairline-b">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center gap-4 mb-12">
          <span
            className="opus-v2-mono text-xs"
            style={{ color: '#71717A' }}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          {content.stats.items.map((item, idx) => {
            ...
            return (
              ...
              >
                <p
                  className="opus-v2-mono text-xs mb-3"
                  style={{ color: '#71717A' }}
                >
                  {item.label}
                </p>
...
/* ============== OVERVIEW ============== */
function Overview({ content }: { content: OpusV2Content }) {
  const o = content.overview;
  return (
    <section
      id="what-is-this"
      className="py-20 md:py-28 opus-v2-hairline-b"
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-7">
            ...
            <a
              href="#optin"
              className="opus-v2-cta-primary inline-flex items-center gap-3 font-bold px-7 py-3.5 rounded-full mt-3"
            >
              {o.ctaLabel}
              <span className="opus-v2-mono text-sm">→</span>
            </a>
          ...
          <div className="md:col-span-5">
            ...
            >
              <p
                className="opus-v2-mono text-xs mb-6"
                style={{ color: '#71717A' }}
              >
                {o.systemCardLabel}
              </p>
              <div className="space-y-5">
                {o.components.map((comp, idx) => (
                  <div key={`overview-comp-${idx}`} className="flex gap-4">
                    ...
                    >
                      <span
                        className="opus-v2-mono font-bold"
...
function SpeakersDay({ content, speakers }: Props) {
  ...
  return (
    <section className="bg-white py-20 md:py-28 opus-v2-hairline-b">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-end justify-between mb-12 pb-4 opus-v2-hairline-b">
          <div>
          ...
          <p
            className="opus-v2-mono text-xs hidden md:block"
            style={{ color: '#71717A' }}
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10">
          {daySpeakers.map((s, idx) => (
            <figure key={s.id}>
              <div
                className="opus-v2-spk-avatar aspect-square rounded-2xl mb-3 flex items-end justify-center pb-5"
                style={{
                  background:
...
/* ============== OUTCOMES ============== */
function Outcomes({ content }: { content: OpusV2Content }) {
...
/* ============== FREE GIFT ============== */
function FreeGift({ content }: { content: OpusV2Content }) {
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-12 gap-12 items-center">
        <div className="md:col-span-5">
          ...
          >
            ...
            <div
              className="absolute inset-x-6 bottom-6 flex flex-col gap-2 opus-v2-mono"
            ...
            <span
              className="absolute top-4 right-4 opus-v2-mono px-2 py-1 rounded"
              style={{
                fontSize: '0.6rem',
                color: '#0A0A0B',
                background: '#C4F245',
        ...
        <div className="md:col-span-7">
          ...
          <ul className="space-y-3 mb-8 opus-v2-mono text-sm">
          ...
          <a
            href="#optin"
            className="opus-v2-cta-primary inline-flex items-center gap-3 font-bold px-8 py-4 rounded-full"
          >
            {g.ctaLabel}
            <span className="opus-v2-mono text-sm">→</span>
          </a>
...
/* ============== BONUS STACK ============== */
function Bonuses({ content }: { content: OpusV2Content }) {
    ...
    <section className="bg-white py-20 md:py-28 opus-v2-hairline-b">
      <div className="max-w-7xl mx-auto px-6">
          ...
          {b.items.map((bonus, idx) => (
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <span
                  className="opus-v2-mono px-2 py-1 rounded font-bold"
                  style={{
                    fontSize: '0.65rem',
                    background: '#C4F245',
                    color: '#0A0A0B',
              ...
              <ul
                className="space-y-2 opus-v2-mono text-xs"
                style={{ color: 'rgba(255,255,255,0.7)' }}
              >
        ...
        <div className="text-center mt-12">
          <a
            href="#optin"
            className="opus-v2-cta-primary inline-flex items-center gap-3 font-bold px-10 py-4 rounded-full text-lg"
          >
            {b.ctaLabel}
            <span className="opus-v2-mono text-sm">→</span>
          </a>
...
/* ============== FOUNDERS ============== */
function Founders({ content }: { content: OpusV2Content }) {
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p
                    className="opus-v2-mono text-xs mt-0.5"
                    style={{ color: '#71717A' }}
                  >
                    {founder.role}
                  </p>
...
/* ============== TESTIMONIALS ============== */
function Testimonials({ content }: { content: OpusV2Content }) {
...
/* ============== PULL QUOTE ============== */
function PullQuote({ content }: { content: OpusV2Content }) {
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6">
        <span
          className="opus-v2-mono text-xs block mb-6"
          style={{ color: '#C4F245' }}
        >
          {pq.eyebrow}
        </span>
...
function Figures({ content }: { content: OpusV2Content }) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-10 gap-y-12">
          {f.items.map((item, idx) => {
            ...
            return (
              <div
                key={`figure-${idx}`}
                className="flex items-start justify-between gap-4 pb-6 opus-v2-hairline-b"
              >
                <div>
                  <p
                    className="opus-v2-mono text-xs mb-3"
                ...
                <div className="opus-v2-spark" aria-hidden="true">
...
/* ============== SHIFTS ============== */
function Shifts({ content }: { content: OpusV2Content }) {
            ...
            return (
              <article
                ...
                className={`grid grid-cols-[auto_1fr] gap-8 items-start ${
                  isLast ? '' : 'pb-8 opus-v2-hairline-b'
                }`}
              >
                <span
                  className="opus-v2-mono font-black text-5xl leading-none"
                  style={{ color: '#AEE02B' }}
                >
                  {String(idx + 1).padStart(2, '0')}
                </span>
...
/* ============== FAQ ============== */
function FAQ({ content }: { content: OpusV2Content }) {
  return (
    <section className="bg-white py-20 md:py-28 opus-v2-hairline-b">
        ...
        <div>
          {content.faqs.map((faq, idx) => (
            <details key={`faq-${idx}`}>
              <summary>
                {faq.question}
                <span className="opus-v2-plus-icon">+</span>
              </summary>
              <p
...
/* ============== FINAL CTA ============== */
function FinalCTA({ content }: { content: OpusV2Content }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <a
          href="#optin"
          className="opus-v2-cta-primary inline-flex items-center gap-3 font-bold px-10 py-5 rounded-full text-lg"
        >
          {c.ctaLabel}
          <span className="opus-v2-mono">→</span>
        </a>
        {c.fineprint ? (
          <p
            className="opus-v2-mono text-xs mt-8"
            style={{ color: '#71717A' }}
          >
            {c.fineprint}
          </p>
...
/* ============== FOOTER ============== */
function Footer({ content }: { content: OpusV2Content }) {
