...
import type { AdhdSummitContent } from './adhd-summit.schema';
import type { Speaker } from './types';

type Props = {
  content: AdhdSummitContent;
...
/* ============== TOP BAR ============== */
function TopBar({ content }: { content: AdhdSummitContent }) {
  return (
    <div className="sticky top-0 z-40 text-white py-4 px-4 shadow-lg" style={{ background: BRAND.c900 }}>
      <div className="max-w-6xl mx-auto flex items-center justify-center">
        <span className="adhd-summit-heading font-bold text-lg md:text-xl tracking-tight">
          {content.topBar.name}
        </span>
      </div>
    </div>
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
        <div>
          <p className="adhd-summit-heading font-bold text-sm mb-3" style={{ color: BRAND.c500 }}>
            {h.eyebrow}
          </p>
          <h1
            className="adhd-summit-heading font-black text-3xl md:text-4xl lg:text-[2.75rem] leading-[1.15] mb-5"
          ...
          <a
            href="#optin"
            className="adhd-summit-pulse-glow inline-block adhd-summit-heading font-bold text-base px-8 py-4 rounded-full mb-4 uppercase tracking-wide text-white"
            ...
            <div className="flex -space-x-2">
              {collage.slice(0, 4).map((s, idx) => (
                <div
                  ...
                  className="adhd-summit-avatar-sm"
          ...
          <div className="grid grid-cols-3 gap-3">
            {collage.slice(0, 6).map((s, idx) => (
              <div key={`collage-${s.id}`} className={`flex flex-col items-center ${COLLAGE_OFFSETS[idx] ?? ''}`}>
                ...
                >
                  <span className="adhd-summit-heading font-bold text-4xl mb-6" style={{ color: 'rgba(255,255,255,0.82)' }}>
                    {initialsFromSpeaker(s)}
                  </span>
                </div>
                <p className="adhd-summit-heading font-bold text-xs mt-2 text-center" style={{ color: BRAND.c900 }}>
                  {displayName(s)}
                </p>
              </div>
            ))}
...
/* ============== PRESS MARQUEE ============== */
function Press({ content }: { content: AdhdSummitContent }) {
  const outlets = content.press.outlets;
  const renderSet = (hidden: boolean) => (
    <div className="adhd-summit-marquee-set" aria-hidden={hidden ? true : undefined}>
      {outlets.map((name, idx) => (
        <span className="adhd-summit-logo-item" key={`press-${hidden ? 'b' : 'a'}-${idx}`}>
          {name}
        </span>
      ))}
    </div>
  ...
  return (
    <section className="bg-white py-10">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <p
          className="adhd-summit-heading font-bold text-xs mb-6 uppercase"
          style={{ color: '#9ca3af', letterSpacing: '0.2em' }}
        >
          {content.press.eyebrow}
        </p>
        <div className="adhd-summit-marquee-container">
          <div className="adhd-summit-marquee-track">
            {renderSet(false)}
            {renderSet(true)}
          </div>
        </div>
...
/* ============== TRUST BADGES ============== */
function TrustBadges({ content }: { content: AdhdSummitContent }) {
  return (
...
/* ============== STATS BAR ============== */
function Stats({ content }: { content: AdhdSummitContent }) {
  return (
    <section className="py-12" style={{ background: BRAND.c500 }}>
      <div className="max-w-4xl mx-auto px-6 grid grid-cols-3 gap-8 text-center text-white">
        {content.stats.items.map((item, idx) => (
          ...
          >
            <p className="adhd-summit-heading font-black text-4xl md:text-5xl">{item.value}</p>
            <p
...
/* ============== OVERVIEW ============== */
function Overview({ content }: { content: AdhdSummitContent }) {
  ...
  return (
    <section id="what-is-this" className="bg-white py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        <div>
          <p
            className="adhd-summit-heading font-bold text-sm uppercase tracking-wider mb-2"
            style={{ color: BRAND.c500 }}
          >
            {o.eyebrow}
          </p>
          <h2
            className="adhd-summit-heading font-black text-3xl md:text-4xl mb-6"
            style={{ color: BRAND.c900 }}
          >
            {o.headline}
          </h2>
          ...
          <a
            href="#optin"
            className="inline-block adhd-summit-heading font-bold text-white px-8 py-4 rounded-full text-base mt-4"
        ...
        >
          <div className="text-center p-8">
            ...
            <p className="adhd-summit-heading font-bold text-xl mb-1" style={{ color: BRAND.c900 }}>
              {o.cardHeadline}
            </p>
...
function SpeakersDay({ content, speakers }: Props) {
  ...
  return (
    <section className="py-16 md:py-24" style={{ background: '#f9fafb' }}>
      <div className="max-w-6xl mx-auto px-6 text-center">
        <span
          className="inline-block adhd-summit-heading font-bold text-white text-sm px-5 py-2 rounded-full mb-4"
          style={{ background: BRAND.c500 }}
        >
          {content.speakersDay.dayBadge}
        </span>
        <h2
          className="adhd-summit-heading font-black text-3xl md:text-4xl mb-12"
          style={{ color: BRAND.c900 }}
        >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {daySpeakers.map((s, idx) => (
            <figure key={s.id} className="flex flex-col items-center">
              <div
                className="adhd-summit-avatar mb-3"
                style={{ background: AVATAR_GRADIENTS[idx % AVATAR_GRADIENTS.length] }}
              >
                {initialsFromSpeaker(s)}
              </div>
              <p className="adhd-summit-heading font-bold" style={{ color: BRAND.c900 }}>
                {displayName(s)}
              </p>
              {s.title ? (
                <p className="text-sm" style={{ color: '#6b7280' }}>
...
/* ============== OUTCOMES ============== */
function Outcomes({ content }: { content: AdhdSummitContent }) {
  const o = content.outcomes;
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="max-w-5xl mx-auto px-6">
        <p
          className="adhd-summit-heading font-bold text-sm uppercase tracking-wider mb-2 text-center"
          style={{ color: BRAND.c500 }}
        >
          {o.eyebrow}
        </p>
        <h2
          className="adhd-summit-heading font-black text-3xl md:text-4xl mb-12 text-center"
          style={{ color: BRAND.c900 }}
        >
          {o.headline}
        </h2>
...
/* ============== FREE GIFT ============== */
function FreeGift({ content }: { content: AdhdSummitContent }) {
    ...
    >
      <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
        <div className="flex justify-center">
          <div className="relative">
            ...
            >
              ...
              <p
                className="adhd-summit-heading font-bold text-sm text-center leading-tight"
                style={{ color: BRAND.c900 }}
              >
                {g.cardTitle}
              </p>
            ...
            <div
              className="absolute -top-3 -right-3 text-white adhd-summit-heading font-black text-xs px-3 py-1.5 rounded-full shadow-lg transform rotate-12"
        ...
        <div>
          ...
          <h2
            className="adhd-summit-heading font-black text-2xl md:text-3xl mb-4"
            style={{ color: BRAND.c900 }}
          >
            {g.headline}
          </h2>
          ...
          <a
            href="#optin"
            className="adhd-summit-pulse-glow inline-block adhd-summit-heading font-bold text-white text-sm px-7 py-3.5 rounded-full uppercase tracking-wide"
            style={{ background: BRAND.c700 }}
          >
            {g.ctaLabel}
          </a>
...
/* ============== BONUSES ============== */
function Bonuses({ content }: { content: AdhdSummitContent }) {
      ...
      <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {b.items.map((bonus, idx) => (
            ...
            >
              <span
                className="inline-block adhd-summit-heading font-bold text-white text-xs px-4 py-1.5 rounded-full mb-4"
                style={{ background: GOLD.c500 }}
              >
                {bonus.valueLabel}
              </span>
              <h3
                className="adhd-summit-heading font-bold text-xl mb-3"
                style={{ color: BRAND.c900 }}
              >
                {bonus.title}
              </h3>
        ...
        <a
          href="#optin"
          className="inline-block mt-10 adhd-summit-heading font-bold text-white px-10 py-4 rounded-full text-lg"
          style={{ background: BRAND.c500 }}
        >
          {b.ctaLabel}
        </a>
...
/* ============== FOUNDERS ============== */
function Founders({ content }: { content: AdhdSummitContent }) {
  const f = content.founders;
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="max-w-5xl mx-auto px-6">
        <h2
          className="adhd-summit-heading font-black text-3xl md:text-4xl text-center mb-12"
          style={{ color: BRAND.c900 }}
        >
          {f.headline}
        </h2>
        <div className="grid md:grid-cols-2 gap-12">
          {f.items.map((founder, idx) => (
            <div key={`founder-${idx}`} className="flex flex-col items-center text-center">
              <div
                className="adhd-summit-avatar adhd-summit-avatar-lg mb-4"
                style={{ background: AVATAR_GRADIENTS[idx % AVATAR_GRADIENTS.length] }}
              >
                {founder.initials}
              </div>
              <h3 className="adhd-summit-heading font-bold text-xl" style={{ color: BRAND.c900 }}>
                {founder.name}
              </h3>
...
/* ============== TESTIMONIALS ============== */
function Testimonials({ content }: { content: AdhdSummitContent }) {
          ...
          {t.items.map((item, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="adhd-summit-heading font-bold text-sm" style={{ color: BRAND.c900 }}>
                    {item.name}
                  </p>
...
/* ============== PULL QUOTE ============== */
function PullQuote({ content }: { content: AdhdSummitContent }) {
  ...
  return (
    <section className="py-14 md:py-20" style={{ background: BRAND.c900 }}>
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <p className="adhd-summit-heading font-bold text-2xl md:text-3xl text-white leading-relaxed italic">
...
/* ============== FIGURES ============== */
function Figures({ content }: { content: AdhdSummitContent }) {
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          {f.items.map((item, idx) => (
            ...
            >
              <p
                className="adhd-summit-heading font-black text-4xl mb-2"
                style={{ color: BRAND.c500 }}
              >
                {item.value}
              </p>
...
/* ============== SHIFTS ============== */
function Shifts({ content }: { content: AdhdSummitContent }) {
        ...
        <div className="space-y-8">
          {s.items.map((item, idx) => (
            <div key={`shift-${idx}`} className="flex gap-6">
              <span
                className="adhd-summit-heading font-black text-5xl leading-none shrink-0"
              ...
              <div>
                <h3
                  className="adhd-summit-heading font-bold text-xl mb-2"
                  style={{ color: BRAND.c900 }}
                >
                  {item.title}
                </h3>
...
/* ============== CLOSING CTA ============== */
function FinalCTA({ content }: { content: AdhdSummitContent }) {
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto px-6 text-center">
        <h2 className="adhd-summit-heading font-black text-3xl md:text-5xl text-white mb-10">
          {c.headline}
        </h2>
        <div className="grid grid-cols-2 gap-3 mb-10 max-w-lg mx-auto">
          {c.chips.map((chip, idx) => (
            <span
              key={`chip-${idx}`}
              className="adhd-summit-heading text-white font-bold text-sm px-4 py-3 rounded-full flex items-center gap-2 justify-center"
              style={{ background: GOLD.c500 }}
            >
              <ChipCheckIcon />
              {chip}
        ...
        <a
          href="#optin"
          className="inline-block adhd-summit-heading font-black text-lg px-12 py-5 rounded-full uppercase tracking-wider shadow-xl"
...
/* ============== FAQ ============== */
function FAQ({ content }: { content: AdhdSummitContent }) {
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="max-w-3xl mx-auto px-6">
        <p
        ...
        <div className="space-y-3">
          {content.faqs.map((faq, idx) => (
            ...
            >
              <summary
                className="flex items-center justify-between p-5 adhd-summit-heading font-bold"
                style={{ color: BRAND.c900 }}
              >
                {faq.question}
                <span className="adhd-summit-chevron text-xl" style={{ color: BRAND.c500 }}>
                  ▼
                </span>
              </summary>
...
/* ============== FOOTER ============== */
function Footer({ content }: { content: AdhdSummitContent }) {
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div
              ...
              style={{ background: BRAND.c500 }}
            >
              <span className="adhd-summit-heading font-black text-white text-lg">
                {f.brandInitial}
              </span>
            </div>
            <div>
              <p className="adhd-summit-heading font-bold text-white text-sm">{f.brandName}</p>
...
/* ============== ROOT COMPONENT ============== */
export function AdhdSummit({ content, speakers, funnelId }: RootProps) {
  return (
    <div className="adhd-summit-root adhd-summit-body">
      <a href="#main-content" className="adhd-summit-skip-nav">
        Skip to content
      </a>
