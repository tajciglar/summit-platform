...
/* ============== STICKY TOP BAR ============== */
function TopBar({ content }: { content: OpusV3Content }) {
...
function Hero({ content, speakers }: Props) {
  ...
  return (
    ...
    >
      <div
        className="opus-v3-blob opus-v3-blob-rose"
        style={{ width: 500, height: 500, top: -100, left: -150 }}
      />
      <div
        className="opus-v3-blob opus-v3-blob-sage"
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-6">
            ...
            >
              <span
                className="opus-v3-eyebrow px-3 py-1.5"
                style={{
                  background: '#A85430',
                  color: '#FAF7F2',
                  borderRadius: 999,
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-12">
              <a href="#optin" className="opus-v3-btn-primary" style={{ fontSize: '1.125rem' }}>
                {h.primaryCtaLabel}
                <span aria-hidden="true">→</span>
              </a>
              <a href="#what-is-this" className="opus-v3-btn-ghost">
                {h.secondaryCtaLabel}
              </a>
            </div>
...
/* ============== PRESS MARQUEE ============== */
function Press({ content }: { content: OpusV3Content }) {
  const items = [...content.press.outlets, ...content.press.outlets];
  return (
    <section className="py-10" style={{ background: '#FAF7F2' }}>
      <div className="max-w-7xl mx-auto px-6">
        <p
          className="opus-v3-eyebrow text-center mb-6"
          style={{ color: '#3D5A4E' }}
        >
          {content.press.eyebrow}
        </p>
        <div className="opus-v3-marquee-wrap">
          <div className="opus-v3-marquee-track">
            {items.map((name, idx) => (
              <span className="opus-v3-marquee-item" key={`press-${idx}`}>
                {name}
              </span>
            ))}
          </div>
...
/* ============== STATS — SAGE BAND ============== */
function Stats({ content }: { content: OpusV3Content }) {
  return (
    <section
    ...
    >
      <svg
        className="opus-v3-wave-top absolute top-0 left-0 right-0"
        viewBox="0 0 1200 40"
      ...
      <div className="max-w-6xl mx-auto px-6 relative">
        <p
          className="opus-v3-eyebrow text-center mb-14 mt-8"
          style={{ color: '#E8B9A0' }}
        >
      ...
      <svg
        className="opus-v3-wave-top absolute bottom-0 left-0 right-0"
        viewBox="0 0 1200 40"
        preserveAspectRatio="none"
        fill="#F4EDE2"
        aria-hidden="true"
...
/* ============== OVERVIEW ============== */
function Overview({ content }: { content: OpusV3Content }) {
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 grid md:grid-cols-12 gap-12 items-center">
        <div className="md:col-span-7">
          <span
            className="opus-v3-eyebrow mb-4 inline-block"
            style={{ color: '#A85430' }}
          >
            {o.eyebrow}
          </span>
          ...
          >
            {o.headlineLead}
            <span className="opus-v3-hand-under" style={{ color: '#4A6B5D' }}>
              {o.headlineAccent}
            </span>
            {o.headlineTrail}
          </h2>
          ...
          <a href="#optin" className="opus-v3-btn-primary">
            {o.ctaLabel}
            <span aria-hidden="true">→</span>
          </a>
        </div>
  ...
  return (
    ...
    >
      <div className="relative max-w-6xl mx-auto px-6 text-center">
        <span
          className="opus-v3-eyebrow mb-3 inline-block"
          style={{ color: '#A85430' }}
        >
          {sd.eyebrow}
        </span>
...
/* ============== OUTCOMES ============== */
function Outcomes({ content }: { content: OpusV3Content }) {
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {o.items.map((item, idx) => (
            <article key={`outcome-${idx}`} className="opus-v3-soft-card p-8">
              <div
...
/* ============== FREE GIFT ============== */
function FreeGift({ content }: { content: OpusV3Content }) {
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="p-8 pl-10 h-full flex flex-col justify-between">
                <div>
                  <p
                    className="opus-v3-eyebrow mb-3"
                    style={{ color: '#4A6B5D' }}
                  >
                    {g.cardEyebrow}
                  </p>
                ...
                <div>
                  ...
                  <p className="opus-v3-eyebrow mt-2" style={{ color: '#8A7E6C' }}>
                    {g.cardVolume}
                  </p>
                </div>
              </div>
        ...
        <div className="md:col-span-7">
          ...
          >
            {g.headlineLead}
            <span className="opus-v3-hand-under">{g.headlineAccent}</span>
            {g.headlineTrail}
          </h2>
          <p
...
/* ============== BONUS STACK ============== */
function Bonuses({ content }: { content: OpusV3Content }) {
    ...
    <section className="py-20 md:py-28" style={{ background: '#F4EDE2' }}>
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          >
            {b.headlineLead}
            <span className="opus-v3-hand-under">{b.headlineAccent}</span>
            {b.headlineTrail}
          </h2>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          {b.items.map((bonus, idx) => (
            <article key={`bonus-${idx}`} className="opus-v3-soft-card p-8">
              <span
...
/* ============== FOUNDERS ============== */
function Founders({ content }: { content: OpusV3Content }) {
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16">
          {f.items.map((founder, idx) => (
            ...
            >
              ...
              <blockquote
                className="opus-v3-dropcap text-xl md:text-2xl leading-relaxed"
                style={{
                  fontFamily: "'Fraunces', serif",
                  fontStyle: 'italic',
                  color: '#3A3221',
...
/* ============== TESTIMONIALS ============== */
function Testimonials({ content }: { content: OpusV3Content }) {
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {t.items.map((item, idx) => (
            <article key={`testimonial-${idx}`} className="opus-v3-soft-card p-8">
              <p
...
/* ============== PULL QUOTE ============== */
function PullQuote({ content }: { content: OpusV3Content }) {
...
function Figures({ content }: { content: OpusV3Content }) {
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
          {f.items.map((item, idx) => (
            <div key={`figure-${idx}`} className="opus-v3-cream-card p-8 text-center">
              <p
...
/* ============== SHIFTS ============== */
function Shifts({ content }: { content: OpusV3Content }) {
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-8">
          {s.items.map((item, idx) => (
            <article
              key={`shift-${idx}`}
              className="opus-v3-soft-card p-7 flex gap-6"
            >
              <span
...
/* ============== FAQ ============== */
function FAQ({ content }: { content: OpusV3Content }) {
  return (
    <section className="py-20 md:py-28" style={{ background: '#FAF7F2' }}>
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div>
          {content.faqs.map((faq, idx) => (
            <details key={`faq-${idx}`}>
              <summary>
                {faq.question}
                <span className="opus-v3-pm-icon">+</span>
              </summary>
              <p
...
/* ============== FINAL CTA ============== */
function FinalCTA({ content }: { content: OpusV3Content }) {
...
/* ============== FOOTER ============== */
function Footer({ content }: { content: OpusV3Content }) {
...
/* ============== ROOT COMPONENT ============== */
export function OpusV3({ content, speakers, funnelId }: RootProps) {
  return (
    <div className="opus-v3-root opus-v3-body antialiased">
      <a href="#main" className="opus-v3-skip-nav">
        Skip to content
      </a>
